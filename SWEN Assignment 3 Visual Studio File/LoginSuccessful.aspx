<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginSuccessful.aspx.cs" Inherits="WebApplication1.LoginSuccessful" %>
...
<body>
    <form id="LoginSuccessful" runat="server">
    <div>
...
&nbsp;&nbsp;&nbsp; Click here to register an account for a User<br />
        ...
        <img alt="" class="style1" 
            src="file:///C:/Users/1105342h/Desktop/my%20WDAD/african%20caretaker.jpg" /></div>
    </form>
</body>
</html>
